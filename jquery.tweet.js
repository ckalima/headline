// Modified to disable user linking and text AWESOMIZING

(function($) {
 
  $.fn.tweet = function(o){
    var s = {
      username: ["asws"],   		          // [string]   required, unless you want to display our tweets. :) it can be an array, just do ["username1","username2","etc"]
    ...
    return this.each(function(i, widget){
      ...
      $.getJSON(build_url(), function(data){
        ...
        $.each(tweets, function(i,item){
		  ...
		  var text = '<span class="tweet_text">' +$([item.text]).linkUrl()[0]+ '</span>';
